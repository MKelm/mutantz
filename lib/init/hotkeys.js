...
$("html").keyup(function(e){
  ...
  } else if (e.which == 117 && mz.game.isEditor == true) { // F6 load level for editor
    mz.game.display.clear("grid");
    mz.game.display.clear("enemies");
    mz.storage.loadLevel(mz.game.currentLevelId);
    mz.game.display.drawGrid();
    mz.game.display.drawEnemies();
    mz.game.display.moveGridToPlayer();
  }
});
