...
$("html").keyup(function(e){
  ...
  } else if (e.which == 115) { // F4 staff
    if (mz.game.displayStaffPanel.visible == false) {
      mz.game.hidePanels();
      mz.game.displayStaffPanel.show();
    } else {
