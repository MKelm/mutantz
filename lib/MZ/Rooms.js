...
MZ.Rooms = function() {
  ...
  this.types = [
    { handle: "space", title: "Space", color: null }, // 0
    { handle: "hangar", title: "Hangar", color: 0x5BFF8F }, // 1
    { handle: "laboratory", title: "Labor- atory", color: 0xFFF95B }, // 2
    { handle: "broodchamber", title: "Brood chamber", color: 0xF45BFF } // 3
  ];
