...
MZ.Map.prototype.fieldPositionByMouse = function(mouse) {
  ...
  var clickPosX = ((oEvent.layerX - mz.pixi.screen.width / 2) - target.parent.position.x) / mz.pixi.screen.ratio,
      clickPosY = ((oEvent.layerY - mz.pixi.screen.height / 2) - target.parent.position.y) / mz.pixi.screen.ratio;
