...
MZ.Map.prototype.fieldPositionByMouse = function(mouse) {
  ...
  var fieldX = this.fieldAmount.x / 2 +
               Math.floor(clickPosX / mz.game.display.mapContainer.scale.x / this.fieldSize.width),
      fieldY = this.fieldAmount.y / 2 +
               Math.floor(clickPosY / mz.game.display.mapContainer.scale.x / this.fieldSize.height);
