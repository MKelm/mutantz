...
MZ.Map.prototype.fieldPositionByMouse = function(mouse) {
  ...
  var fieldX = this.fieldAmount.x / 2 +
               Math.round(clickPosX / mz.pixi.screen.ratio / target.parent.scale.x / this.fieldSize.width - 0.5),
      fieldY = this.fieldAmount.y / 2 +
               Math.round(clickPosY / mz.pixi.screen.ratio / target.parent.scale.x / this.fieldSize.height - 0.5);
