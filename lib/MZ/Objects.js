...
MZ.Objects = function() {
  ...
  this.types = [
    { handle: "helper", title: "Helper", type: "char", speed: 60, staff: true }, // 0
    { handle: "transportship", title: "Transport ship", type: "ship", speed: 90, staff: false } // 1
  ];
...
MZ.Objects.prototype.setObject = function(type, position, sprite) {
  this.list.push(
    { type: type, position: position, sprite: sprite, tasks: new MZ.ObjectTasks(), movement: false }
  );
