...
MZ.Display.prototype.activateMapZoom = function() {
  ...
  $('html').bind('mousewheel', function(e) {
    if (e.originalEvent.wheelDelta / 120 > 0 &&
      ...
      console.log(scope.mapContainer.scale.x);
...
MZ.Display.prototype.drawSelection = function(mode, position, width, height) {
  if (mode == "start") this.mapSelectionGfx = new PIXI.Graphics();
  ...
  if (mode == "start") this.mapContainer.addChild(this.mapSelectionGfx);
}

MZ.Display.prototype.removeSelection = function() {
  if (this.mapContainer.children.indexOf(this.mapSelectionGfx) !== -1)
    this.mapContainer.removeChild(this.mapSelectionGfx);
  this.mapSelectionGfx = null;
}