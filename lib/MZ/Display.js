...
MZ.Display.prototype.drawObject = function(object) {
  ...
  sprite.position = {
    x: object.position.x * mz.game.map.fieldSize.width + mz.game.map.fieldSize.width/2 - mz.game.map.fieldAmount.x / 2 * mz.game.map.fieldSize.width,
    y: object.position.y * mz.game.map.fieldSize.height + mz.game.map.fieldSize.width/2 - mz.game.map.fieldAmount.y / 2 * mz.game.map.fieldSize.height
  };
