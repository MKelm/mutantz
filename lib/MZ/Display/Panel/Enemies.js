...
MZ.DisplayPanelEnemies.prototype.drawEnemyObjects = function() {
  var x = 10; y = 10, scope = this, gfx = new PIXI.Graphics(), enemies = mz.game.enemies, imageName = null;
  gfx.alpha = 0.5;
  this.container.addChild(gfx);
  for (var i = 0; i < enemies.types.length; i++) {
    imageName = (i > 0) ? "enemy_"+enemies.types[i].handle : "blank";
    var sprite = new PIXI.Sprite(PIXI.Texture.fromFrame("data/gfx/"+imageName+".png"));
