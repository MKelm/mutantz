...
MZ.Version.prototype.constructor = MZ.Version;

MZ.Version.prototype.getCommitHash = function(callback) {
  var fs = require('fs');
...
MZ.Version.prototype.getVersionHash = function(callback) {
...
MZ.Version.prototype.updateHashesFile = function() {
  var hashes = './HASHES';
  var fs = require('fs');
  var scope = this;
