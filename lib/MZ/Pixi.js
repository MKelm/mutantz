...
MZ.Pixi = function() {
  this.screen = { width: 1024, height: 768, ratio: 0 };
...
MZ.Pixi.prototype.loadAssets = function(callback) {
  ...
  var assetsToLoad = [
    ...
    "data/gfx/field_empty.png", "data/gfx/field_floor.png",
    "data/gfx/field_wall.png", "data/gfx/field_grid.png",
    "data/gfx/obj_helper.png", "data/gfx/obj_transportship.png"
